    ...
    <div className='header text-center'><p><b>FAQs</b></p></div>
      <Accordion className="faq" defaultActiveKey="0" flush>
        <Accordion.Item eventKey="0">
          ...
          Right on the border? Contact us and we can discuss which class is the best fit for your dog.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          <Accordion.Header className='mb-3'>Can more than one person come?</Accordion.Header>
          <Accordion.Body className="accordion-body mb-2">
          ...
          we suggest bringing a book or iPad to keep them occupied.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="2">
          <Accordion.Header className='mb-3'>I have more than one dog! Can they all come to class? Do you have multi-dog discounts?</Accordion.Header>
          <Accordion.Body className="accordion-body mb-2">
          ...
          four-legged family members. We do not offer multi-dog discounts.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="4">
          <Accordion.Header className='mb-3'>What do I need to start class?</Accordion.Header>
          <Accordion.Body className="accordion-body mb-2">
        ...
        <Accordion.Item eventKey="6">
          <Accordion.Header className='mb-3'>I missed a class, what should I do to make it up?</Accordion.Header>
          <Accordion.Body className="accordion-body mb-2">
          ...
          Please contact us to schedule a makeup lesson.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="7">
          <Accordion.Header className='mb-3'>Can you help with potty training?</Accordion.Header>
          <Accordion.Body className="accordion-body mb-2">
