...
const Adoption = () => {
  return (
    ...
    <MDBBtn href='#' className="button-addopt ">Donate</MDBBtn>
    </div>
    <MDBRow className='row-cols-1 row-cols-md-3 g-4'>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "BLACKY"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "BOGART"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "MAX"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
    </MDBRow>
    ...
    <MDBRow className='row-cols-1 row-cols-md-3 g-4 mt-5'>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "LUFFY"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "BANTAY"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "MANNY"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
    </MDBRow>
    ...
    <MDBRow className='row-cols-1 row-cols-md-3 g-4 mt-5'>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT " Athos, Porthos, and Aramis"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "WHITEY"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          ...
          <MDBCardFooter>
            <p className="adopt"><b>ADOPT "OLDY"</b></p>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
    </MDBRow>
